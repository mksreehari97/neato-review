...
jQuery(document).ready(function($) {
    ...
    $(".cost-slider-input").on("paste change keyup input", function() {
        var self = $(this);
        ...
        if ($("[data-input='" + self.attr("id") + "']").length && self.attr("type") != "checkbox")
            setTimeout(function() {
    ...
    var counters = function() {
        $(".counters-group").each(function() {
            ...
            var height = 83 / groupHeight * 100;
            counterBoxes.each(function(index) {
                var self = $(this);
                currentValue = parseInt(self.find("[data-value]").data("value").toString().replace(" ", ""), 10);
                height = 83 * (1 - currentValue / topValue) / groupHeight * 100;
